...
\begin{frame}{What are Reservoir Computers?}
  \begin{columns}
    \column{0.5\textwidth}
    Reservoir computers learn by example how to...
    \begin{itemize}
    \item transform an input signal into an output signal
    \item perform system forecasting
      \vspace{2em}
    \item perform system control\footnote[frame]{\fullcite{canaday2020}}
    \end{itemize}
    \column{0.5\textwidth}
    \centering
...
\begin{frame}{Conclusion}
  ...
  \end{itemize}
  \begin{center}
    % FIXME line network with inputs
    \includegraphics[draft,width=\textwidth,height=4em]{figures/lorenz}
  \end{center}
  \begin{itemize}
