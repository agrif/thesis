...
states.  For simplicity and consistency, in this dissertation I will
...
As a discrete-time map, the trained NVAR may have fixed points
...
% FIXME compare (check nvar paper)
